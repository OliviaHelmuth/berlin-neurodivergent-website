...
export const metadata = { title: "Neurocinema 2024" };

export default function Neurocinema2024Page() {
  return (
    <Container className="py-16">
      <h1 className="mb-4 text-3xl font-bold text-zinc-900 dark:text-zinc-50">Neurocinema 2024</h1>
